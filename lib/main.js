...
var getGeoLocationAndCheckRecentQuakes = function()
{
    ...
    {
        console.debug("We don't have permission to get geo location, not checking for earthquakes...");
...
var promptForGeoLocationPermission = function()
{
    ...
    acceptButton.callback = function() { simpleStorage.storage.hasGeoLocationPermission = true; };
...
widgets.Widget({
    ...
    onClick: function(e) { shakeBrowserWindow(100); }
});
